...
short_model_first = Model(u_initial=1, c=11, rate=1, mu=5.5, t_end=10)
long_model_first = Model(u_initial=1, c=11, rate=1, mu=5.5, t_end=1000)
...
short_model_second = Model(u_initial=10, c=28.875, rate=5, mu=5.5, t_end=10)
long_model_second = Model(u_initial=10, c=28.875, rate=5, mu=5.5, t_end=1000)
